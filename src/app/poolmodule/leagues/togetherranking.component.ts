...
import { NameService, Poule, CompetitorMap, GameAmountConfig, GameState, ScoreConfigService, TogetherGame, CompetitionSport, TogetherGamePlace, TogetherSportRoundRankingCalculator, SportRoundRankingItem, PlaceLocation, SingleSportVariant, AllInOneGameSportVariant, AgainstSportVariant, Place } from 'ngx-sport';
